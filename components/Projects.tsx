      ...
      <div className="mx-auto max-w-7xl">
        <SectionReveal>
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            ...
            <a
              href="#contact"
              className="inline-flex items-center gap-2 text-sm font-semibold text-[var(--color-slate-900)]"
            >
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-2">
          {properties.map((property, index) => (
            <SectionReveal key={property.id} delay={index * 0.08}>
              <article className="overflow-hidden rounded-[2rem] border border-[var(--color-border)] bg-[var(--color-surface)] shadow-[0_24px_70px_rgba(16,33,58,0.08)]">
                <div className="relative overflow-hidden">
                  ...
                  />
                  <div className="absolute left-5 top-5 inline-flex rounded-full bg-[rgba(16,33,58,0.82)] px-4 py-2 text-xs font-semibold uppercase tracking-[0.24em] text-white backdrop-blur">
                    {property.status}
                  </div>
                </div>
                <div className="p-7">
